/*
	...
	Important: Do not modify this file. Edit the file SqlEdStudIntTrnsCourseFromProvider.cs instead.
*/
...
namespace UMIS_VER2.AccessLayer.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlEdStudIntTrnsCourseFromProviderBase : EdStudIntTrnsCourseFromProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlEdStudIntTrnsCourseFromProviderBase"/> instance.
		/// </summary>
		public SqlEdStudIntTrnsCourseFromProviderBase()
		{
		}
	...
	public SqlEdStudIntTrnsCourseFromProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Decimal _edStudIntTrnsCourseFromId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseFromId", DbType.Decimal, _edStudIntTrnsCourseFromId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(EdStudIntTrnsCourseFrom)
					,_edStudIntTrnsCourseFromId);
		...
		public override TList<EdStudIntTrnsCourseFrom> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<EdStudIntTrnsCourseFrom>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseFromId", DbType.Decimal, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@EdStudIntTrnsId", DbType.Decimal, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("ed_stud_int_trns_course_from_id ") || clause.Trim().StartsWith("ed_stud_int_trns_course_from_id="))
				{
					database.SetParameterValue(commandWrapper, "@EdStudIntTrnsCourseFromId", 
			...
			//Create Collection
			TList<EdStudIntTrnsCourseFrom> rows = new TList<EdStudIntTrnsCourseFrom>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom objects.</returns>
		public override TList<EdStudIntTrnsCourseFrom> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_Find_Dynamic", typeof(EdStudIntTrnsCourseFromColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom objects.</returns>
		public override TList<EdStudIntTrnsCourseFrom> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdAcadYearId(TransactionManager transactionManager, System.Decimal? _edAcadYearId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdAcadYearId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdCodeCourseStatusId(TransactionManager transactionManager, System.Decimal? _edCodeCourseStatusId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdCodeCourseStatusId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdCodeGradingId(TransactionManager transactionManager, System.Decimal? _edCodeGradingId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdCodeGradingId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdCodeSemesterId(TransactionManager transactionManager, System.Decimal? _edCodeSemesterId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdCodeSemesterId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEntPolicyAssessHdrId(TransactionManager transactionManager, System.Decimal? _entPolicyAssessHdrId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEntPolicyAssessHdrId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEntPolicyGradingHdrId(TransactionManager transactionManager, System.Decimal? _entPolicyGradingHdrId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEntPolicyGradingHdrId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByGsCodePassFailId(TransactionManager transactionManager, System.Decimal? _gsCodePassFailId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByGsCodePassFailId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByAsFacultyInfoId(TransactionManager transactionManager, System.Decimal _asFacultyInfoId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByAsFacultyInfoId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdCourseId(TransactionManager transactionManager, System.Decimal _edCourseId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdCourseId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdStudId(TransactionManager transactionManager, System.Decimal? _edStudId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdStudId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseFrom> GetByEdStudIntTrnsId(TransactionManager transactionManager, System.Decimal _edStudIntTrnsId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdStudIntTrnsId", _useStoredProcedure);
		...
		#region GetByEdStudIntTrnsCourseFromId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom GetByEdStudIntTrnsCourseFromId(TransactionManager transactionManager, System.Decimal _edStudIntTrnsCourseFromId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_GetByEdStudIntTrnsCourseFromId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseFromId", DbType.Decimal, _edStudIntTrnsCourseFromId);
			
			IDataReader reader = null;
			TList<EdStudIntTrnsCourseFrom> tmp = new TList<EdStudIntTrnsCourseFrom>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEdStudIntTrnsCourseFromId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEdStudIntTrnsCourseFromId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// <remarks>
		///		After inserting into the datasource, the UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom> entities)
		{
			...
			bulkCopy.DestinationTableName = "ED_STUD_INT_TRNS_COURSE_FROM";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("ED_STUD_INT_TRNS_COURSE_FROM_ID", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("ED_STUD_INT_TRNS_COURSE_FROM_ID", "ED_STUD_INT_TRNS_COURSE_FROM_ID");
			...
			foreach(UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["ED_STUD_INT_TRNS_COURSE_FROM_ID"] = entity.EdStudIntTrnsCourseFromId;
		...
		/// <summary>
		/// 	Inserts a UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@EdStudIntTrnsCourseFromId", DbType.Decimal, 5);
			...
			object _edStudIntTrnsCourseFromId = database.GetParameterValue(commandWrapper, "@EdStudIntTrnsCourseFromId");
			entity.EdStudIntTrnsCourseFromId = (System.Decimal)_edStudIntTrnsCourseFromId;
			
			entity.OriginalEdStudIntTrnsCourseFromId = entity.EdStudIntTrnsCourseFromId;
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom object to update.</param>
		/// <remarks>
		///		After updating the datasource, the UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseFrom entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_FROM_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseFromId", DbType.Decimal, entity.EdStudIntTrnsCourseFromId );
			database.AddInParameter(commandWrapper, "@OriginalEdStudIntTrnsCourseFromId", DbType.Decimal, entity.OriginalEdStudIntTrnsCourseFromId);
			database.AddInParameter(commandWrapper, "@EdCourseId", DbType.Decimal, entity.EdCourseId );
			database.AddInParameter(commandWrapper, "@AuditFlg", DbType.Decimal, entity.AuditFlg );
			database.AddInParameter(commandWrapper, "@RepeatFlg", DbType.Decimal, entity.RepeatFlg );
			database.AddInParameter(commandWrapper, "@IsLast", DbType.Decimal, entity.IsLast );
