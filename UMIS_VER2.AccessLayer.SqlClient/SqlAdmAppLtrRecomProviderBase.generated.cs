/*
	...
	Important: Do not modify this file. Edit the file SqlAdmAppLtrRecomProvider.cs instead.
*/
...
namespace UMIS_VER2.AccessLayer.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlAdmAppLtrRecomProviderBase : AdmAppLtrRecomProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlAdmAppLtrRecomProviderBase"/> instance.
		/// </summary>
		public SqlAdmAppLtrRecomProviderBase()
		{
		}
	...
	public SqlAdmAppLtrRecomProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Decimal _admAppLtrRecomId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@AdmAppLtrRecomId", DbType.Decimal, _admAppLtrRecomId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(AdmAppLtrRecom)
					,_admAppLtrRecomId);
		...
		public override TList<AdmAppLtrRecom> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<AdmAppLtrRecom>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@AdmAppLtrRecomId", DbType.Decimal, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LetterPath", DbType.String, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LastDate", DbType.DateTime, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("adm_app_ltr_recom_id ") || clause.Trim().StartsWith("adm_app_ltr_recom_id="))
				{
					database.SetParameterValue(commandWrapper, "@AdmAppLtrRecomId", 
				...
				if (clause.Trim().StartsWith("letter_path ") || clause.Trim().StartsWith("letter_path="))
				{
					database.SetParameterValue(commandWrapper, "@LetterPath", 
			...
			//Create Collection
			TList<AdmAppLtrRecom> rows = new TList<AdmAppLtrRecom>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.AdmAppLtrRecom objects.</returns>
		public override TList<AdmAppLtrRecom> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_Find_Dynamic", typeof(AdmAppLtrRecomColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AdmAppLtrRecom> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.AdmAppLtrRecom objects.</returns>
		public override TList<AdmAppLtrRecom> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AdmAppLtrRecom> GetByAdmAppRegHistoryId(TransactionManager transactionManager, System.Decimal? _admAppRegHistoryId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_GetByAdmAppRegHistoryId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AdmAppLtrRecom> GetByAdmApplicantId(TransactionManager transactionManager, System.Decimal _admApplicantId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_GetByAdmApplicantId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AdmApplicantId", DbType.Decimal, _admApplicantId);
			
			IDataReader reader = null;
			TList<AdmAppLtrRecom> tmp = new TList<AdmAppLtrRecom>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override UMIS_VER2.BusinessLyer.AdmAppLtrRecom GetByAdmAppLtrRecomId(TransactionManager transactionManager, System.Decimal _admAppLtrRecomId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_GetByAdmAppLtrRecomId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAdmAppLtrRecomId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAdmAppLtrRecomId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<UMIS_VER2.BusinessLyer.AdmAppLtrRecom> entities)
		{
			...
			bulkCopy.DestinationTableName = "ADM_APP_LTR_RECOM";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("ADM_APP_LTR_RECOM_ID", typeof(System.Decimal));
			...
			DataColumn col4 = dataTable.Columns.Add("MOB_NUM", typeof(System.String));
			...
			DataColumn col7 = dataTable.Columns.Add("LETTER_PATH", typeof(System.String));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("ADM_APP_REG_HISTORY_ID", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("ADM_APP_LTR_RECOM_ID", "ADM_APP_LTR_RECOM_ID");
			...
			bulkCopy.ColumnMappings.Add("LETTER_PATH", "LETTER_PATH");
			...
			foreach(UMIS_VER2.BusinessLyer.AdmAppLtrRecom entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["ADM_APP_LTR_RECOM_ID"] = entity.AdmAppLtrRecomId;
					...
					row["LETTER_PATH"] = entity.LetterPath;
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@AdmAppLtrRecomId", DbType.Decimal, 5);
			...
			object _admAppLtrRecomId = database.GetParameterValue(commandWrapper, "@AdmAppLtrRecomId");
			entity.AdmAppLtrRecomId = (System.Decimal)_admAppLtrRecomId;
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.AdmAppLtrRecom object to update.</param>
		/// <remarks>
		///		After updating the datasource, the UMIS_VER2.BusinessLyer.AdmAppLtrRecom object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.AdmAppLtrRecom entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ADM_APP_LTR_RECOM_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@AdmAppLtrRecomId", DbType.Decimal, entity.AdmAppLtrRecomId );
			database.AddInParameter(commandWrapper, "@OriginalAdmAppLtrRecomId", DbType.Decimal, entity.OriginalAdmAppLtrRecomId);
			database.AddInParameter(commandWrapper, "@AdmApplicantId", DbType.Decimal, entity.AdmApplicantId );
			database.AddInParameter(commandWrapper, "@Name", DbType.String, entity.Name );
			database.AddInParameter(commandWrapper, "@JobTitle", DbType.String, entity.JobTitle );
			database.AddInParameter(commandWrapper, "@MobNum", DbType.String, entity.MobNum );
