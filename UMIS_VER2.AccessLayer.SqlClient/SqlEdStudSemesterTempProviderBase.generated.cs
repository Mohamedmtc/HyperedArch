/*
	...
	Important: Do not modify this file. Edit the file SqlEdStudSemesterTempProvider.cs instead.
*/
...
namespace UMIS_VER2.AccessLayer.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlEdStudSemesterTempProviderBase : EdStudSemesterTempProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlEdStudSemesterTempProviderBase"/> instance.
		/// </summary>
		public SqlEdStudSemesterTempProviderBase()
		{
		}
	...
	public SqlEdStudSemesterTempProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Decimal _edStudSemesterId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(EdStudSemesterTemp)
					,_edStudSemesterId);
		...
		public override TList<EdStudSemesterTemp> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<EdStudSemesterTemp>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@HaveSponsor", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@HaveInstallment", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@NationalitySimilarityFlg", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@HaveDiscount", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@HaveRetrieve", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@HavePostponement", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@HaveRemission", DbType.Decimal, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@EdCdeExamTypeId", DbType.Decimal, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("have_sponsor ") || clause.Trim().StartsWith("have_sponsor="))
				{
					database.SetParameterValue(commandWrapper, "@HaveSponsor", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("have_installment ") || clause.Trim().StartsWith("have_installment="))
				{
					database.SetParameterValue(commandWrapper, "@HaveInstallment", 
						clause.Trim().Remove(0,16).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				if (clause.Trim().StartsWith("have_discount ") || clause.Trim().StartsWith("have_discount="))
				{
					database.SetParameterValue(commandWrapper, "@HaveDiscount", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("have_retrieve ") || clause.Trim().StartsWith("have_retrieve="))
				{
					database.SetParameterValue(commandWrapper, "@HaveRetrieve", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("have_postponement ") || clause.Trim().StartsWith("have_postponement="))
				{
					database.SetParameterValue(commandWrapper, "@HavePostponement", 
						clause.Trim().Remove(0,17).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("have_remission ") || clause.Trim().StartsWith("have_remission="))
				{
					database.SetParameterValue(commandWrapper, "@HaveRemission", 
			...
			//Create Collection
			TList<EdStudSemesterTemp> rows = new TList<EdStudSemesterTemp>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.EdStudSemesterTemp objects.</returns>
		public override TList<EdStudSemesterTemp> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_Find_Dynamic", typeof(EdStudSemesterTempColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.EdStudSemesterTemp objects.</returns>
		public override TList<EdStudSemesterTemp> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByAsFacultyInfoId(TransactionManager transactionManager, System.Decimal? _asFacultyInfoId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByAsFacultyInfoId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdAcadYearId(TransactionManager transactionManager, System.Decimal _edAcadYearId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdAcadYearId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdCdeAcadWarnTypeId(TransactionManager transactionManager, System.Decimal? _edCdeAcadWarnTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdCdeAcadWarnTypeId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdCodeEnrollTypeId(TransactionManager transactionManager, System.Decimal? _edCodeEnrollTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdCodeEnrollTypeId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEdCodeEnrollTypeId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEdCodeEnrollTypeId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdCodeLevelId(TransactionManager transactionManager, System.Decimal? _edCodeLevelId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdCodeLevelId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdCodeLoadTypeId(TransactionManager transactionManager, System.Decimal? _edCodeLoadTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdCodeLoadTypeId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdCodeSemesterId(TransactionManager transactionManager, System.Decimal _edCodeSemesterId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdCodeSemesterId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdStudId(TransactionManager transactionManager, System.Decimal _edStudId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdStudId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByFeeFacultyRuleId(TransactionManager transactionManager, System.Decimal? _feeFacultyRuleId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByFeeFacultyRuleId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudSemesterTemp> GetByEdCdeExamTypeId(TransactionManager transactionManager, System.Decimal? _edCdeExamTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdCdeExamTypeId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override UMIS_VER2.BusinessLyer.EdStudSemesterTemp GetByEdStudSemesterId(TransactionManager transactionManager, System.Decimal _edStudSemesterId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdStudSemesterId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@EdStudSemesterId", DbType.Decimal, _edStudSemesterId);
			
			IDataReader reader = null;
			TList<EdStudSemesterTemp> tmp = new TList<EdStudSemesterTemp>();
			try
			{
				//Provider Data Requesting Command Event
		...
		#region GetByEdStudIdEdAcadYearIdEdCodeSemesterIdAsFacultyInfoId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override UMIS_VER2.BusinessLyer.EdStudSemesterTemp GetByEdStudIdEdAcadYearIdEdCodeSemesterIdAsFacultyInfoId(TransactionManager transactionManager, System.Decimal _edStudId, System.Decimal _edAcadYearId, System.Decimal _edCodeSemesterId, System.Decimal? _asFacultyInfoId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_GetByEdStudIdEdAcadYearIdEdCodeSemesterIdAsFacultyInfoId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEdStudIdEdAcadYearIdEdCodeSemesterIdAsFacultyInfoId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEdStudIdEdAcadYearIdEdCodeSemesterIdAsFacultyInfoId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// <remarks>
		///		After inserting into the datasource, the UMIS_VER2.BusinessLyer.EdStudSemesterTemp object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<UMIS_VER2.BusinessLyer.EdStudSemesterTemp> entities)
		{
			...
			bulkCopy.DestinationTableName = "ED_STUD_SEMESTER_TEMP";
			...
			DataColumn col25 = dataTable.Columns.Add("HAVE_SPONSOR", typeof(System.Decimal));
			col25.AllowDBNull = true;		
			DataColumn col26 = dataTable.Columns.Add("HAVE_INSTALLMENT", typeof(System.Decimal));
			col26.AllowDBNull = true;		
			DataColumn col27 = dataTable.Columns.Add("NATIONALITY_SIMILARITY_FLG", typeof(System.Decimal));
			col27.AllowDBNull = true;		
			DataColumn col28 = dataTable.Columns.Add("HAVE_DISCOUNT", typeof(System.Decimal));
			col28.AllowDBNull = true;		
			DataColumn col29 = dataTable.Columns.Add("HAVE_RETRIEVE", typeof(System.Decimal));
			col29.AllowDBNull = true;		
			DataColumn col30 = dataTable.Columns.Add("HAVE_POSTPONEMENT", typeof(System.Decimal));
			col30.AllowDBNull = true;		
			DataColumn col31 = dataTable.Columns.Add("HAVE_REMISSION", typeof(System.Decimal));
			col31.AllowDBNull = true;		
			DataColumn col32 = dataTable.Columns.Add("FEE_FACULTY_RULE_ID", typeof(System.Decimal));
			col32.AllowDBNull = true;		
			DataColumn col33 = dataTable.Columns.Add("STUD_CARD_STKR_FLG", typeof(System.Decimal));
			col33.AllowDBNull = true;		
			DataColumn col34 = dataTable.Columns.Add("STUD_CARD_STKR_DATE", typeof(System.DateTime));
			col34.AllowDBNull = true;		
			DataColumn col35 = dataTable.Columns.Add("FEE_TOT_AMNT", typeof(System.Decimal));
			col35.AllowDBNull = true;		
			DataColumn col36 = dataTable.Columns.Add("FEE_PAY_AMNT", typeof(System.Decimal));
			col36.AllowDBNull = true;		
			DataColumn col37 = dataTable.Columns.Add("FEE_REFUND_AMNT", typeof(System.Decimal));
			col37.AllowDBNull = true;		
			DataColumn col38 = dataTable.Columns.Add("PAY_FLG", typeof(System.Decimal));
			col38.AllowDBNull = true;		
			DataColumn col39 = dataTable.Columns.Add("FREEZE_FLG", typeof(System.Decimal));
			col39.AllowDBNull = true;		
			DataColumn col40 = dataTable.Columns.Add("AS_CODE_DEGREE_ID", typeof(System.Decimal));
			col40.AllowDBNull = true;		
			DataColumn col41 = dataTable.Columns.Add("ED_CDE_ACAD_WARN_TYPE_ID", typeof(System.Decimal));
			col41.AllowDBNull = true;		
			DataColumn col42 = dataTable.Columns.Add("NOTES", typeof(System.String));
			col42.AllowDBNull = true;		
			DataColumn col43 = dataTable.Columns.Add("SEM_COUNT", typeof(System.Decimal));
			col43.AllowDBNull = true;		
			DataColumn col44 = dataTable.Columns.Add("ED_CDE_EXAM_TYPE_ID", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("HAVE_SPONSOR", "HAVE_SPONSOR");
			bulkCopy.ColumnMappings.Add("HAVE_INSTALLMENT", "HAVE_INSTALLMENT");
			bulkCopy.ColumnMappings.Add("NATIONALITY_SIMILARITY_FLG", "NATIONALITY_SIMILARITY_FLG");
			bulkCopy.ColumnMappings.Add("HAVE_DISCOUNT", "HAVE_DISCOUNT");
			bulkCopy.ColumnMappings.Add("HAVE_RETRIEVE", "HAVE_RETRIEVE");
			bulkCopy.ColumnMappings.Add("HAVE_POSTPONEMENT", "HAVE_POSTPONEMENT");
			bulkCopy.ColumnMappings.Add("HAVE_REMISSION", "HAVE_REMISSION");
			...
			foreach(UMIS_VER2.BusinessLyer.EdStudSemesterTemp entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["IS_COURSE_APPROVED"] = entity.IsCourseApproved.HasValue ? (object) entity.IsCourseApproved  : System.DBNull.Value;
					...
					row["HAVE_SPONSOR"] = entity.HaveSponsor.HasValue ? (object) entity.HaveSponsor  : System.DBNull.Value;
							
				
					row["HAVE_INSTALLMENT"] = entity.HaveInstallment.HasValue ? (object) entity.HaveInstallment  : System.DBNull.Value;
					...
					row["HAVE_DISCOUNT"] = entity.HaveDiscount.HasValue ? (object) entity.HaveDiscount  : System.DBNull.Value;
							
				
					row["HAVE_RETRIEVE"] = entity.HaveRetrieve.HasValue ? (object) entity.HaveRetrieve  : System.DBNull.Value;
							
				
					row["HAVE_POSTPONEMENT"] = entity.HavePostponement.HasValue ? (object) entity.HavePostponement  : System.DBNull.Value;
							
				
					row["HAVE_REMISSION"] = entity.HaveRemission.HasValue ? (object) entity.HaveRemission  : System.DBNull.Value;
					...
					row["FREEZE_FLG"] = entity.FreezeFlg.HasValue ? (object) entity.FreezeFlg  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a UMIS_VER2.BusinessLyer.EdStudSemesterTemp object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.EdStudSemesterTemp object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the UMIS_VER2.BusinessLyer.EdStudSemesterTemp object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.EdStudSemesterTemp entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@IsCourseApproved", DbType.Decimal, (entity.IsCourseApproved.HasValue ? (object) entity.IsCourseApproved  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@HaveSponsor", DbType.Decimal, (entity.HaveSponsor.HasValue ? (object) entity.HaveSponsor  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@HaveInstallment", DbType.Decimal, (entity.HaveInstallment.HasValue ? (object) entity.HaveInstallment  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@HaveDiscount", DbType.Decimal, (entity.HaveDiscount.HasValue ? (object) entity.HaveDiscount  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@HaveRetrieve", DbType.Decimal, (entity.HaveRetrieve.HasValue ? (object) entity.HaveRetrieve  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@HavePostponement", DbType.Decimal, (entity.HavePostponement.HasValue ? (object) entity.HavePostponement  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@HaveRemission", DbType.Decimal, (entity.HaveRemission.HasValue ? (object) entity.HaveRemission  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@FreezeFlg", DbType.Decimal, (entity.FreezeFlg.HasValue ? (object) entity.FreezeFlg  : System.DBNull.Value));
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.EdStudSemesterTemp object to update.</param>
		/// <remarks>
		///		After updating the datasource, the UMIS_VER2.BusinessLyer.EdStudSemesterTemp object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.EdStudSemesterTemp entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_SEMESTER_TEMP_Update", _useStoredProcedure);
