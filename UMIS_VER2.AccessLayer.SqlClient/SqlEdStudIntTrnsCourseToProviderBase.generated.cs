/*
	...
	Important: Do not modify this file. Edit the file SqlEdStudIntTrnsCourseToProvider.cs instead.
*/
...
namespace UMIS_VER2.AccessLayer.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlEdStudIntTrnsCourseToProviderBase : EdStudIntTrnsCourseToProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlEdStudIntTrnsCourseToProviderBase"/> instance.
		/// </summary>
		public SqlEdStudIntTrnsCourseToProviderBase()
		{
		}
	...
	public SqlEdStudIntTrnsCourseToProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Decimal _edStudIntTrnsCourseToId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseToId", DbType.Decimal, _edStudIntTrnsCourseToId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(EdStudIntTrnsCourseTo)
					,_edStudIntTrnsCourseToId);
		...
		public override TList<EdStudIntTrnsCourseTo> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<EdStudIntTrnsCourseTo>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseToId", DbType.Decimal, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@EdCodeTransCourseTypeId", DbType.Decimal, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("ed_stud_int_trns_course_to_id ") || clause.Trim().StartsWith("ed_stud_int_trns_course_to_id="))
				{
					database.SetParameterValue(commandWrapper, "@EdStudIntTrnsCourseToId", 
			...
			//Create Collection
			TList<EdStudIntTrnsCourseTo> rows = new TList<EdStudIntTrnsCourseTo>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo objects.</returns>
		public override TList<EdStudIntTrnsCourseTo> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_Find_Dynamic", typeof(EdStudIntTrnsCourseToColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo objects.</returns>
		public override TList<EdStudIntTrnsCourseTo> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByAsFacultyInfoId(TransactionManager transactionManager, System.Decimal _asFacultyInfoId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByAsFacultyInfoId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdAcadYearId(TransactionManager transactionManager, System.Decimal? _edAcadYearId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdAcadYearId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdCodeCourseStatusId(TransactionManager transactionManager, System.Decimal? _edCodeCourseStatusId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdCodeCourseStatusId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdCodeGradingId(TransactionManager transactionManager, System.Decimal? _edCodeGradingId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdCodeGradingId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdCodeSemesterId(TransactionManager transactionManager, System.Decimal? _edCodeSemesterId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdCodeSemesterId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdCodeTransCourseTypeId(TransactionManager transactionManager, System.Decimal _edCodeTransCourseTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdCodeTransCourseTypeId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEdCodeTransCourseTypeId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEdCodeTransCourseTypeId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdCourseId(TransactionManager transactionManager, System.Decimal _edCourseId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdCourseId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdStudId(TransactionManager transactionManager, System.Decimal? _edStudId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdStudId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEdStudIntTrnsId(TransactionManager transactionManager, System.Decimal _edStudIntTrnsId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdStudIntTrnsId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEntPolicyAssessHdrId(TransactionManager transactionManager, System.Decimal? _entPolicyAssessHdrId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEntPolicyAssessHdrId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByEntPolicyGradingHdrId(TransactionManager transactionManager, System.Decimal? _entPolicyGradingHdrId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEntPolicyGradingHdrId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EdStudIntTrnsCourseTo> GetByGsCodePassFailId(TransactionManager transactionManager, System.Decimal? _gsCodePassFailId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByGsCodePassFailId", _useStoredProcedure);
		...
		#region GetByEdStudIntTrnsCourseToId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo GetByEdStudIntTrnsCourseToId(TransactionManager transactionManager, System.Decimal _edStudIntTrnsCourseToId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdStudIntTrnsCourseToId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseToId", DbType.Decimal, _edStudIntTrnsCourseToId);
			
			IDataReader reader = null;
			TList<EdStudIntTrnsCourseTo> tmp = new TList<EdStudIntTrnsCourseTo>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEdStudIntTrnsCourseToId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEdStudIntTrnsCourseToId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		#region GetByEdStudIntTrnsIdEdCourseId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo GetByEdStudIntTrnsIdEdCourseId(TransactionManager transactionManager, System.Decimal _edStudIntTrnsId, System.Decimal _edCourseId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_GetByEdStudIntTrnsIdEdCourseId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEdStudIntTrnsIdEdCourseId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEdStudIntTrnsIdEdCourseId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// <remarks>
		///		After inserting into the datasource, the UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo> entities)
		{
			...
			bulkCopy.DestinationTableName = "ED_STUD_INT_TRNS_COURSE_TO";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("ED_STUD_INT_TRNS_COURSE_TO_ID", typeof(System.Decimal));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("ED_COURSE_ID", typeof(System.Decimal));
			col1.AllowDBNull = false;		
			DataColumn col2 = dataTable.Columns.Add("AUDIT_FLG", typeof(System.Decimal));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("REPEAT_FLG", typeof(System.Decimal));
			col3.AllowDBNull = false;		
			DataColumn col4 = dataTable.Columns.Add("IS_LAST", typeof(System.Decimal));
			col4.AllowDBNull = false;		
			DataColumn col5 = dataTable.Columns.Add("AS_FACULTY_INFO_ID", typeof(System.Decimal));
			col5.AllowDBNull = false;		
			DataColumn col6 = dataTable.Columns.Add("ED_CODE_COURSE_STATUS_ID", typeof(System.Decimal));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("ED_CODE_GRADING_ID", typeof(System.Decimal));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("COURSE_DEGREE", typeof(System.Decimal));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("COURSE_POINT", typeof(System.Decimal));
			...
			DataColumn col12 = dataTable.Columns.Add("ADD_GPA_FLG", typeof(System.Decimal));
			col12.AllowDBNull = false;		
			DataColumn col13 = dataTable.Columns.Add("ADD_MJRGPA_FLG", typeof(System.Decimal));
			col13.AllowDBNull = false;		
			DataColumn col14 = dataTable.Columns.Add("ENT_POLICY_ASSESS_HDR_ID", typeof(System.Decimal));
			col14.AllowDBNull = true;		
			DataColumn col15 = dataTable.Columns.Add("INCOMP_FLG", typeof(System.Decimal));
			col15.AllowDBNull = false;		
			DataColumn col16 = dataTable.Columns.Add("ED_ACAD_YEAR_ID", typeof(System.Decimal));
			...
			DataColumn col18 = dataTable.Columns.Add("ED_STUD_ID", typeof(System.Decimal));
			col18.AllowDBNull = true;		
			DataColumn col19 = dataTable.Columns.Add("ED_STUD_INT_TRNS_ID", typeof(System.Decimal));
			col19.AllowDBNull = false;		
			DataColumn col20 = dataTable.Columns.Add("ED_CODE_TRANS_COURSE_TYPE_ID", typeof(System.Decimal));
			col20.AllowDBNull = false;		
			
			bulkCopy.ColumnMappings.Add("ED_STUD_INT_TRNS_COURSE_TO_ID", "ED_STUD_INT_TRNS_COURSE_TO_ID");
			...
			foreach(UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["ED_STUD_INT_TRNS_COURSE_TO_ID"] = entity.EdStudIntTrnsCourseToId;
		...
		/// <summary>
		/// 	Inserts a UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@EdStudIntTrnsCourseToId", DbType.Decimal, 5);
			...
			object _edStudIntTrnsCourseToId = database.GetParameterValue(commandWrapper, "@EdStudIntTrnsCourseToId");
			entity.EdStudIntTrnsCourseToId = (System.Decimal)_edStudIntTrnsCourseToId;
			
			entity.OriginalEdStudIntTrnsCourseToId = entity.EdStudIntTrnsCourseToId;
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo object to update.</param>
		/// <remarks>
		///		After updating the datasource, the UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, UMIS_VER2.BusinessLyer.EdStudIntTrnsCourseTo entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.ED_STUD_INT_TRNS_COURSE_TO_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@EdStudIntTrnsCourseToId", DbType.Decimal, entity.EdStudIntTrnsCourseToId );
			database.AddInParameter(commandWrapper, "@OriginalEdStudIntTrnsCourseToId", DbType.Decimal, entity.OriginalEdStudIntTrnsCourseToId);
			database.AddInParameter(commandWrapper, "@EdCourseId", DbType.Decimal, entity.EdCourseId );
			database.AddInParameter(commandWrapper, "@AuditFlg", DbType.Decimal, entity.AuditFlg );
			database.AddInParameter(commandWrapper, "@RepeatFlg", DbType.Decimal, entity.RepeatFlg );
			database.AddInParameter(commandWrapper, "@IsLast", DbType.Decimal, entity.IsLast );
