...
{
	/// <summary>
	///		The data structure representation of the 'SV_USER_TASK' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface ISvUserTask 
	{
		/// <summary>			
		/// SV_USER_TASK_ID : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "SV_USER_TASK"</remarks>
		System.Decimal SvUserTaskId { get; set; }
				
		/// <summary>
		/// keep a copy of the original so it can be used for editable primary keys.
		/// </summary>
		System.Decimal OriginalSvUserTaskId { get; set; }
		...
		/// TASK_TITLE : 
		/// </summary>
		System.String  TaskTitle  { get; set; }
		
		/// <summary>
		/// TASK_DTL : 
		/// </summary>
		System.String  TaskDtl  { get; set; }
