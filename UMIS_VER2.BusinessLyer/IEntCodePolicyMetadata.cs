...
{
	/// <summary>
	///		The data structure representation of the 'ENT_CODE_POLICY_METADATA' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IEntCodePolicyMetadata 
	{
		/// <summary>			
		...
		/// </summary>
		System.Decimal OriginalEntCodePolicyMdId { get; set; }
