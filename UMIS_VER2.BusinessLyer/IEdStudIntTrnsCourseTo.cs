...
{
	/// <summary>
	///		The data structure representation of the 'ED_STUD_INT_TRNS_COURSE_TO' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IEdStudIntTrnsCourseTo 
	{
		/// <summary>			
		...
		System.Decimal EdStudIntTrnsCourseToId { get; set; }
				
		/// <summary>
		/// keep a copy of the original so it can be used for editable primary keys.
		/// </summary>
		System.Decimal OriginalEdStudIntTrnsCourseToId { get; set; }
