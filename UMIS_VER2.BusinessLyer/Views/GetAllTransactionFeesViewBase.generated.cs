/*
	...
	Important: Do not modify this file. Edit the file GetAllTransactionFeesView.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'GetAllTransactionFeesView' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("GetAllTransactionFeesViewBase")]
	public abstract partial class GetAllTransactionFeesViewBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// Bank : 
		/// </summary>
		private System.Decimal?		  _bank = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="GetAllTransactionFeesViewBase"/> instance.
		///</summary>
		public GetAllTransactionFeesViewBase()
		{
		}		
		...
		public GetAllTransactionFeesViewBase(System.Decimal? _edStudId, System.Decimal? _feesId, System.Decimal _feeCodeItemId, System.DateTime? _transactionDate, System.Decimal _yearId, System.Decimal? _semester, System.Decimal? _depit, System.Decimal? _credit, System.Decimal? _credit2, System.Int32 _transactionType, System.Decimal? _discType, System.Decimal? _discountStatus, System.Int32? _discCat, System.Int32? _refundType, System.Decimal? _yearOfLoad, System.Decimal? _semOfLoad, System.Decimal? _payMethod, System.Decimal? _credit3, System.Decimal? _refundValue, System.Decimal? _vouchearId, System.String _recieptNum, System.Decimal? _applicantId, System.Decimal? _feeStudFeeItemId, System.Decimal? _bank)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="GetAllTransactionFeesView"/> instance.
		///</summary>
		///<param name="_edStudId"></param>
		///<param name="_feesId"></param>
		///<param name="_feeCodeItemId"></param>
		...
		///<param name="_feeStudFeeItemId"></param>
		///<param name="_bank"></param>
		public static GetAllTransactionFeesView CreateGetAllTransactionFeesView(System.Decimal? _edStudId, System.Decimal? _feesId, System.Decimal _feeCodeItemId, System.DateTime? _transactionDate, System.Decimal _yearId, System.Decimal? _semester, System.Decimal? _depit, System.Decimal? _credit, System.Decimal? _credit2, System.Int32 _transactionType, System.Decimal? _discType, System.Decimal? _discountStatus, System.Int32? _discCat, System.Int32? _refundType, System.Decimal? _yearOfLoad, System.Decimal? _semOfLoad, System.Decimal? _payMethod, System.Decimal? _credit3, System.Decimal? _refundValue, System.Decimal? _vouchearId, System.String _recieptNum, System.Decimal? _applicantId, System.Decimal? _feeStudFeeItemId, System.Decimal? _bank)
		{
			GetAllTransactionFeesView newGetAllTransactionFeesView = new GetAllTransactionFeesView();
			newGetAllTransactionFeesView.EdStudId = _edStudId;
			newGetAllTransactionFeesView.FeesId = _feesId;
			newGetAllTransactionFeesView.FeeCodeItemId = _feeCodeItemId;
			newGetAllTransactionFeesView.TransactionDate = _transactionDate;
			newGetAllTransactionFeesView.YearId = _yearId;
			newGetAllTransactionFeesView.Semester = _semester;
			newGetAllTransactionFeesView.Depit = _depit;
			newGetAllTransactionFeesView.Credit = _credit;
			newGetAllTransactionFeesView.Credit2 = _credit2;
			newGetAllTransactionFeesView.TransactionType = _transactionType;
			newGetAllTransactionFeesView.DiscType = _discType;
			newGetAllTransactionFeesView.DiscountStatus = _discountStatus;
			newGetAllTransactionFeesView.DiscCat = _discCat;
			newGetAllTransactionFeesView.RefundType = _refundType;
			newGetAllTransactionFeesView.YearOfLoad = _yearOfLoad;
			newGetAllTransactionFeesView.SemOfLoad = _semOfLoad;
			newGetAllTransactionFeesView.PayMethod = _payMethod;
			newGetAllTransactionFeesView.Credit3 = _credit3;
			newGetAllTransactionFeesView.RefundValue = _refundValue;
			newGetAllTransactionFeesView.VouchearId = _vouchearId;
			newGetAllTransactionFeesView.RecieptNum = _recieptNum;
			newGetAllTransactionFeesView.ApplicantId = _applicantId;
			newGetAllTransactionFeesView.FeeStudFeeItemId = _feeStudFeeItemId;
			newGetAllTransactionFeesView.Bank = _bank;
			return newGetAllTransactionFeesView;
		}
		...
		/// <summary>
		/// 	Gets or Sets the Bank property. 
		///		
		/// </summary>
		/// <value>This type is numeric</value>
		/// <remarks>
		/// This property can be set to null. 
		/// If this column is null, this property will return 0.0m. It is up to the developer
		/// to check the value of IsBankNull() and perform business logic appropriately.
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.Decimal? Bank
		{
			get
			{
				return this._bank; 
		...
		{
			get { return "GetAllTransactionFeesView"; }
		}
		...
		///<summary>
		///  Returns a Typed GetAllTransactionFeesViewBase Entity 
		///</summary>
		public virtual GetAllTransactionFeesViewBase Copy()
		{
			//shallow copy entity
			GetAllTransactionFeesView copy = new GetAllTransactionFeesView();
				...
				copy.Bank = this.Bank;
			copy.AcceptChanges();
			return (GetAllTransactionFeesView)copy;
		}
		...
		///<returns>true if toObject is a <see cref="GetAllTransactionFeesViewBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(GetAllTransactionFeesViewBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="GetAllTransactionFeesViewBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="GetAllTransactionFeesViewBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="GetAllTransactionFeesViewBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(GetAllTransactionFeesViewBase Object1, GetAllTransactionFeesViewBase Object2)
		{
			// both are null
			...
			if (Object1.Bank != null && Object2.Bank != null )
			{
				if (Object1.Bank != Object2.Bank)
					equal = false;
			}
			else if (Object1.Bank == null ^ Object1.Bank == null )
			{
				equal = false;
			}
			return equal;
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(GetAllTransactionFeesView entity, string propertyName)
		{
			switch (propertyName)
			{
				case "EdStudId":
		...
		{			
			return GetPropertyValueByName(this as GetAllTransactionFeesView, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{25}{24}- EdStudId: {0}{24}- FeesId: {1}{24}- FeeCodeItemId: {2}{24}- TransactionDate: {3}{24}- YearId: {4}{24}- Semester: {5}{24}- Depit: {6}{24}- Credit: {7}{24}- Credit2: {8}{24}- TransactionType: {9}{24}- DiscType: {10}{24}- DiscountStatus: {11}{24}- DiscCat: {12}{24}- RefundType: {13}{24}- YearOfLoad: {14}{24}- SemOfLoad: {15}{24}- PayMethod: {16}{24}- Credit3: {17}{24}- RefundValue: {18}{24}- VouchearId: {19}{24}- RecieptNum: {20}{24}- ApplicantId: {21}{24}- FeeStudFeeItemId: {22}{24}- Bank: {23}{24}", 
				...
				(this.Bank == null) ? string.Empty : this.Bank.ToString(),
	...
	/// <summary>
	/// Enumerate the GetAllTransactionFeesView columns.
	/// </summary>
	[Serializable]
	public enum GetAllTransactionFeesViewColumn
	{
		/// <summary>
		/// EdStudId : 
		/// </summary>
		...
		/// </summary>
		[EnumTextValue("Bank")]
		[ColumnEnum("Bank", typeof(System.Decimal), System.Data.DbType.Decimal, false, false, true)]
		Bank
	}//End enum
